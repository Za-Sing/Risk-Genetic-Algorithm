...
Brisk::Brisk()
{
	...
	board.push_back(Region(0, "Alaska", vector<int>{1, 3, 24})); //GOOD
	board.push_back(Region(1, "Northwest_Territory", vector<int>{0, 3, 4, 2})); //GOOD
	board.push_back(Region(2, "Greenland", vector<int>{1, 4, 5, 13})); //GOOD
	board.push_back(Region(3, "Alberta", vector<int>{0, 1, 4, 6})); //GOOD
	board.push_back(Region(4, "Ontario", vector<int>{1, 2, 5, 7, 6, 3})); //GOOD
	board.push_back(Region(5, "Eastern_Canada", vector<int>{4, 2, 7})); //GOOD
	board.push_back(Region(6, "Western_United_States", vector<int>{3, 4, 7, 8})); //GOOD
	board.push_back(Region(7, "Eastern_United_States", vector<int>{6, 4, 5, 8})); //GOOD
	board.push_back(Region(8, "Central_America", vector<int>{6, 7, 9})); //GOOD
	board.push_back(Region(9, "Venezuela", vector<int>{8, 10, 11})); //GOOD
	board.push_back(Region(10, "Brazil", vector<int>{9, 11, 12, 32})); //GOOD
	board.push_back(Region(11, "Peru", vector<int>{9, 10, 12})); //GOOD
	board.push_back(Region(12, "Argentina", vector<int>{10, 11})); //GOOD
	board.push_back(Region(13, "Iceland", vector<int>{2, 14, 16})); //GOOD
	board.push_back(Region(14, "Scandinavia", vector<int>{13, 15, 16, 17})); //GOOD
	board.push_back(Region(15, "Russia", vector<int>{14, 17, 19, 20, 25, 29})); //GOOD
	board.push_back(Region(16, "Great_Britain", vector<int>{13, 14, 17, 18})); //GOOD
	board.push_back(Region(17, "Northern_Europe", vector<int>{14, 15, 16, 18, 19})); //GOOD
	board.push_back(Region(18, "Western_Europe", vector<int>{16, 17, 19, 32})); //GOOD
	board.push_back(Region(19, "Southern_Europe", vector<int>{15, 17, 18, 29, 32, 33})); //GOOD
	board.push_back(Region(20, "Ural", vector<int>{15, 21, 25, 26})); //GOOD
	board.push_back(Region(21, "Siberia", vector<int>{20, 22, 23, 26, 27})); //GOOD
	board.push_back(Region(22, "Yakutsk", vector<int>{21, 23, 24})); //GOOD
	board.push_back(Region(23, "Irkutsk", vector<int>{21, 22, 24, 27})); //GOOD
	board.push_back(Region(24, "Kamchatka", vector<int>{0, 22, 23, 27, 28})); //GOOD
	board.push_back(Region(25, "Afghanistan", vector<int>{15, 20, 26, 29, 30})); //GOOD
	board.push_back(Region(26, "China", vector<int>{20, 21, 25, 27, 30, 31})); //GOOD
	board.push_back(Region(27, "Mongolia", vector<int>{21, 23, 24, 26, 28})); //GOOD
	board.push_back(Region(28, "Japan", vector<int>{24, 27})); //GOOD
	board.push_back(Region(29, "Middle_East", vector<int>{15, 19, 25, 30, 33, 34})); //GOOD
	board.push_back(Region(30, "India", vector<int>{25, 26, 29, 31})); //GOOD
	board.push_back(Region(31, "Southeast_Asia", vector<int>{26, 30, 38})); //GOOD
	board.push_back(Region(32, "North_Africa", vector<int>{10, 18, 19, 33, 34, 35})); //GOOD
	board.push_back(Region(33, "Egypt", vector<int>{19, 29, 32, 34})); //GOOD
	board.push_back(Region(34, "East_Africa", vector<int>{29, 32, 33, 35, 36, 37})); //GOOD
	board.push_back(Region(35, "Central_Africa", vector<int>{32, 34, 36})); //GOOD
	board.push_back(Region(36, "South_Africa", vector<int>{34, 35, 37})); //GOOD
	board.push_back(Region(37, "Madagascar", vector<int>{34, 36})); //GOOD
	board.push_back(Region(38, "Indonesia", vector<int>{31, 39, 40})); //GOOD
	board.push_back(Region(39, "New_Guinea", vector<int>{38, 41})); //GOOD
	board.push_back(Region(40, "Western_Australia", vector<int>{38, 41})); //GOOD
